# Bolt [![Coverage Status](https://coveralls.io/repos/NandVinchhi/bolt/badge.svg?branch=master)](https://coveralls.io/r/NandVinchhi/bolt?branch=master) [![GoDoc](https://godoc.org/github.com/NandVinchhi/bolt?status.svg)](https://godoc.org/github.com/NandVinchhi/bolt) ![Version](https://img.shields.io/badge/version-1.2.1-green.svg)
...
```sh
$ go get github.com/NandVinchhi/bolt/...
```
...
system's page cache. See the [`Tx`](https://godoc.org/github.com/NandVinchhi/bolt#Tx)
...
[page-allocation]: https://github.com/NandVinchhi/bolt/issues/308#issuecomment-74811638
